    ...
    <div>
      <Controller
        ...
        rules={{
          validate: {
            lessThan10MB: (files) =>
              files?.size < 2000 * 1000 ||
              "عکس انتخابی نباید بیشتر از 2 مگابایت باشد.",
          },
        }}
        render={({
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-6">
              <button
                className="w-[160px] h-[80px] border border-dashed flex flex-col items-center justify-center rounded-lg text-hgray-350 border-hgray-300"
                type="button"
            ...
            {error ? (
              <p className="text-sm text-rose-500 mt-3 font-semibold">
                {error.message}
              </p>
            ) : null}
          </div>
