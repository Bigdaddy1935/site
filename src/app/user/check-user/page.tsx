...
export default function CheckUserPage() {
  return (
    <Container className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)]">
      <h3 className="text-xl text-primary-700 dark:text-text-dark-3 font-semibold text-center mb-7">
        ورود یا ثبت نام در
        <br />
        <span className="text-primary-600 dark:text-primary-50 font-extrabold mt-4 block text-2xl">آکادمی روح بخش</span>
      </h3>
